...
public class MultiValuedFilterTest {
    ...
    public void setUp() {
        ...
        new NonStrictExpectations() {{
            ...
            jdbcTemplate.query(query1, new DropDownItemMapper());
            result = genDropDownItemResults(query1);
            jdbcTemplate.query(query2, new DropDownItemMapper());
            result = genDropDownItemResults(query2);
            jdbcTemplate.query(query3, new DropDownItemMapper());
            result = genDropDownItemResults(query3);
            jdbcTemplate.query(query4, new DropDownItemMapper());
